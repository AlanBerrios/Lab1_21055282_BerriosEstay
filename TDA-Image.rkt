...
;Los siguientes TDAs son necesarios para crear el TDA image que esta al final de este archivo
...
#| Documentacion: TDA-dentrodelarea?
Descripcion: Verifica si las coordenadas x e y de cada pixel estan dentro del alto y ancho de la imagen
Tipo de algoritmo/estrategia: No aplica
Dominio(Argumento de entrada): Lista de n-variables (pixbit-d | pixrgb-d | pixhex-d)
Recorrido(Retorno): Booleano
|#
